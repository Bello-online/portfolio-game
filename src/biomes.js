...
//   weather: snow | embers | spores | dust | motes | none
//   liquid:  { level, color, lava? } fills terrain below `level`
export const BIOMES = {
  ice: {
    label: 'Frozen',
    planet: 0x8fa7bf, planetAlt: 0xd7e6f2, planetSea: 0x3b5a80, caps: true, clouds: 0.9,
    ...
    weather: 'snow', liquid: { level: -1.7, color: 0x2a4a6a, ice: true },
  },
  ash: {
    label: 'Volcanic',
    planet: 0x3a3a42, planetAlt: 0xff6a2a, lava: true, clouds: 0.4,
    ...
    weather: 'embers', liquid: { level: -1.5, color: 0xff4a10, lava: true },
  },
  dust: {
    label: 'Desert',
    planet: 0xb8783f, planetAlt: 0xe0a86a, rings: true, clouds: 0.3,
  ...
  crystal: {
    label: 'Crystalline',
    planet: 0x5a3f7f, planetAlt: 0xb48cff, clouds: 0.5,
    ...
    weather: 'motes', liquid: { level: -1.8, color: 0x6a3fbf, glow: true },
  },
  jungle: {
    label: 'Overgrown',
    planet: 0x2f6b3a, planetAlt: 0x8fd07a, planetSea: 0x1f4a6a, moonlet: true, clouds: 1.0,
    ...
    props: { rocks: 40, trees: 55, crystals: 8, structures: 5 }, scatter: 'tufts', grass: true,
    weather: 'spores', liquid: { level: -1.4, color: 0x1f5a4a },
  },
  moon: {
    label: 'Barren',
    planet: 0x8c9098, planetAlt: 0xc9ccd2, craters: true, clouds: 0,
